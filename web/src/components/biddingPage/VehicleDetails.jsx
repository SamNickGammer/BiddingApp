...
export default function VehicleDetails({ vehicle }) {
    ...
    const handleQuantityChange = (event) => {
        ...
        // Ensure the value is a positive integer (or handle validations as needed)
        if (!isNaN(value) && parseInt(value) >= vehicle.startPrice) {
                    ...
                    <div>
                        ...
                        <div className="mt-6 flex items-center gap-8 text-xs">
                            <div className="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
                                <svg className="h-6 w-6 text-indigo-700 dark:text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="mt-4 flex justify-end mr-8  space-x-2 items-center">
                            ...
                            <button className="px-4 py-1 bg-indigo-600 text-white text-sm font-medium rounded-lg shadow-sm hover:bg-indigo-500">
                                Bid
                            </button>
                        </div>
                    </div>
