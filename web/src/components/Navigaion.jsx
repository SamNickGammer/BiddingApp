        ...
        <div className="hidden md:block">
          <nav aria-label="Global">
            <ul className="flex items-center gap-6 text-sm">
              <li>
                <Link to='/' className="text-gray-500 dark:text-gray-300 transition hover:text-gray-500/75"> Home </Link>
              </li>
              <li>
                <Link to='/biding' className="text-gray-500 dark:text-gray-300 transition hover:text-gray-500/75"> Bid </Link>
              </li>
              <li>
                <Link to='/about' className="text-gray-500 dark:text-gray-300 transition hover:text-gray-500/75"> About </Link>
              </li>
            </ul>
          </nav>
        </div>
